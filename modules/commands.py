...
def commands():
    ...
    tsv_translate_parser.add_argument('--tolang', '-to', default='es', help='The language to translate to')
    tsv_translate_parser.add_argument('--log', '-l', default=False, help='Print log to console and log file')
    tsv_translate_parser.add_argument('--log_file', '-lf', default='log.txt', help='The log file to write to')
    ...
    tsv2rpy_parser.add_argument('--log', '-l', default=False, help='Print log to console and log file')
    tsv2rpy_parser.add_argument('--log_file', '-lf', default='log.txt', help='The log file to write to')
    tsv2rpy_parser.add_argument('--tl_lang', '-tl', default='japanese', help='The target language to translate to')
    tsv2rpy_parser.add_argument('--comment', '-c', default=True, help='Add comments to the RenPy script')
    ...
    extract_menu_parser.add_argument('--log', '-l', default=False, help='Print log to console and log file')
    extract_menu_parser.add_argument('--log_file', '-lf', default='log.txt', help='The log file to write to')
    ...
    tsv_translate_menu_parser.add_argument('--tolang', '-to', default='es', help='The language to translate to')
    tsv_translate_menu_parser.add_argument('--log', '-l', default=False, help='Print log to console and log file')
    tsv_translate_menu_parser.add_argument('--log_file', '-lf', default='log.txt', help='The log file to write to')
    ...
    tsv2rpy_menu_parser.add_argument('--log', '-l', default=False, help='Print log to console and log file')
    tsv2rpy_menu_parser.add_argument('--log_file', '-lf', default='log.txt', help='The log file to write to')
    tsv2rpy_menu_parser.add_argument('--tl_lang', '-tl', default='japanese', help='The target language to translate to')
    tsv2rpy_menu_parser.add_argument('--comment', '-c', default=True, help='Add comments to the RenPy script')
